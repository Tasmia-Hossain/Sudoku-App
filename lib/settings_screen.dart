...
// import 'package:init_project/statistics_screen.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            //_buildMistakesLimitSwitch(context),
            SizedBox(height: 16),
              ...
              children: [
                ...
                Text(
                  'Welcome to the Sudoku App – your ultimate puzzle-solving companion!'
                      ...
                      '\n- No time limit Level for: Beginners'
